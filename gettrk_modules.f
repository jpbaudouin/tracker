c	28-09-17 Baudouin   maxspeed_tc set to 100
      module def_vitals
...
c
      module inparms
        type datecard  ! Define a new type for the input namelist parms
          ...
          character*6   filetype ! 'netcdf' or 'grib'
        end type datecard
      end module inparms
c
      module trkrparms
        type trackstuff  ! Define a new type for various tracker parms
          ...
          character*1   choose_t2  ! Flag for whether to the next threshold
          real          mslpthresh2 ! min mslp to be detected
...
c
      module contours
        integer, parameter :: maxconts=1000 ! max # of cont. intervals
...
c
      module error_parms
        real, parameter :: err_gfs_init=275.0 ! init errmax for gfs,mrf
                                              ! and gdas
        real, parameter :: err_reg_init=350.0 !300.0 ! init errmax for others
        real, parameter :: err_ecm_max=330.0  ! errmax for ecmwf
        real, parameter :: err_reg_max=350.0 ! 225.0  ! errmax for others for
                                              ! remaining fcst times
        real, parameter :: maxspeed_tc=100  ! max speed of storm movement
...
c
      module set_max_parms
        ...
        integer, parameter :: maxstorm_mg=10000  ! max # of storms pgm can
